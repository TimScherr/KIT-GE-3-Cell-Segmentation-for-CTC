...
# Specialized models trained on GTs and STs from the reproduced kit-sch-ge training dataset (iterations=1 has been used from now on since we were running out of time for the challenge)
