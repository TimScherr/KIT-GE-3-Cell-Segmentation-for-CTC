...
python ./cell_eval.py --cell_type "BF-C2DL-HSC" --mode "GT" --model "BF-C2DL-HSC_GT+ST_kit-sch-ge" --batch_size 16 --artifact_correction --th_cell 0.07 --th_seed 0.35 0.45
python ./cell_eval.py --cell_type "BF-C2DL-MuSC" --mode "GT" --model "BF-C2DL-MuSC_GT+ST_kit-sch-ge" --batch_size 8 --artifact_correction --th_cell 0.07 --th_seed 0.35 0.45
python ./cell_eval.py --cell_type "DIC-C2DH-HeLa" --mode "GT" --model "DIC-C2DH-HeLa_GT+ST_kit-sch-ge" --batch_size 16 --th_cell 0.07 --th_seed 0.35 0.45
python ./cell_eval.py --cell_type "Fluo-C2DL-MSC" --mode "GT" --model "Fluo-C2DL-MSC_GT+ST_kit-sch-ge" --batch_size 16 --th_cell 0.07 --th_seed 0.35 0.45
python ./cell_eval.py --cell_type "Fluo-C3DH-A549" --mode "GT" --model "Fluo-C3DH-A549_GT+ST_kit-sch-ge" --batch_size 8 --th_cell 0.07 --th_seed 0.35 0.45
...
python ./cell_eval.py --cell_type "PhC-C2DL-PSC" --mode "GT" --model "PhC-C2DL-PSC_GT+ST_kit-sch-ge" --batch_size 16 --th_cell 0.07 --th_seed 0.35 0.45
